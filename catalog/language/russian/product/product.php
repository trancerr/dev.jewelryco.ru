...
$_['text_cart']    = 'Добавить <br />в корзину';
$_['text_raspordazha']    = 'РАСПРОДАЖА';
$_['text_tablica_razmerov']    = 'Таблица размеров';
$_['text_tablica_razmerov1']    = 'ТАБЛИЦА РАЗМЕРОВ';
$_['text_tablica_razmer']    = 'Размер';
$_['text_tablica_obhvat1']    = 'Обхват груди (см)';
$_['text_tablica_obhvat2']    = 'Обхват бёдер (см)';
$_['text_category_name']    = 'Подраздел в каталоге';
$_['text_description']    = 'Описание';
$_['text_description_content']    = '<h3>Примечание</h3><p>Добро пожаловать в интернет-магазин белорусского трикотажа: модной и стильной белорусской женской одежды.</p>';
$_['text_otzyv']    = 'Ваш отзыв';
