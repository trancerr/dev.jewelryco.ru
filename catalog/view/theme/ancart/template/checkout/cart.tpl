...
<div id="content"><?php echo $content_top; ?>
 <!-- <div class="breadcrumb">
   ...
   <div class="htabs-main">
    ...
    &nbsp;(<?php echo $weight; ?>)
    <?php } ?>
<div style="border:1px solid #d1c09d">
        ...
        <tbody>
          ...
          <tr>
            <td class="image"><?php if ($product['thumb']) { ?>
              ...
              <?php } ?></td>
            <td class="name" style="line-height:26px;"><a href="<?php echo $product['href']; ?>">Артикул <?php echo $product['sku']; ?></a>
              <?php if (!$product['stock']) { ?>
              <span class="stock">***</span>
              <?php } ?>
              <br /><br />
                <?php foreach ($product['option'] as $option) { ?>
                <?php echo $option['name']; ?> <?php if ($option['image'] == '') echo $option['value']; else echo '<img style="position:absolute" src="'.$option['image'].'" />';?><br />
                <?php } ?>
                <br />
                <?php if($product['recurring']): ?>
                <?php echo $text_payment_profile ?>: <?php echo $product['profile_name'] ?>
                <?php endif; ?>
           ...
           <!-- <td class="model"><?php echo $product['model']; ?></td>-->
            <td class="quantity">
            	<?php echo $column_quantity; ?><br /><br />
...
<!--              <input type="image" src="catalog/view/theme/default/image/update.png" alt="<?php echo $button_update; ?>" title="<?php echo $button_update; ?>" />-->
            ...
            <!--<td class="price"><?php echo $column_price; ?><br /><br /><?php echo $product['price']; ?></td>-->
            <td class="model">Статус заказа<br /><br />Новый</td>
            <td class="total"><?php echo $column_total; ?><br /><br /><?php echo $product['total']; ?></td>
          </tr>
          <?php } ?>
  ...
  <?php if (0) {//if ($coupon_status || $voucher_status || $reward_status || $shipping_status) { ?>
  ...
  <div class="buttons">
    <div class="right"><a href="<?php echo $checkout; ?>" class="button cart"><?php echo $button_checkout; ?></a></div>
